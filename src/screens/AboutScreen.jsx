            ...
            <div className="container" style={{zIndex: 1, flexDirection:"column"}}>
                ...
                <div className="about-section" style={{display: "flex", justifyContent:"space-between"}}>
                    ...
                    <HolderCard label={"German"}>
                        ...
                        <p>I'm originally from Moscow, so I grew up writing Cyrillic and speaking Russian. After immigrating to the U.S., my background fueled interest in everything at the intersection of tech and language, which I also explored during my undergrad at Stanford studying CS (NLP) and Linguistics.</p>  
